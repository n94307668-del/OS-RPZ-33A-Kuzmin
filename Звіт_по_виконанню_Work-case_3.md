...
*Налаштування мережевих адаптерів (Adapter 1 - NAT)*
...
*Налаштування спільної папки в VirtualBox*
...
*Файл скопійований у домашній каталог першої ВМ*
...
*Копіювання файлу з ВМ у спільну папку*
